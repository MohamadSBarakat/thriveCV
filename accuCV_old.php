...
<div class="row">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Secteur D'activite</a>
...
<header class="container-fluid">
    <nav class="navbar navbar-expand-lg" style="background-color: #108245;width: 100%;">
        ...
        <div class="input-group">
            ...
            <div class="row">
                <div class="  ">
                    <select class="custom-select style= width: 200%;" name ="actv" id="inputGroupSelect01">
                        <option selected>Secteur D'activite</option>
                        <?php  
                          foreach  ($act as $active) {
                          $dogRace = $race->nameRace;
